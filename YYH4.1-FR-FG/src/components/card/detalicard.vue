<template>
  <div class="wrapper">
    <el-dialog title="详情" :visible.sync="isShow.detail" width="800px" @open="init" :close-on-click-modal="false">
      <div>
       <el-form label-width="40px"  class="demo-ruleForm">
             ...
             <el-row style="marginTop:25px">
              ...
              <el-row style="marginTop:25px">
               ...
               <el-row style="marginTop:20px;">
                            <span style="marginLeft:60px;lineHeight:44px;marginRight:20px">经办人</span>{{str.creatorName}}
                </el-row>
            ...
            <div slot="footer" class="dialog-footer" >
              <ul style="display:flex;marginTop:10px">
                ...
                <li class="actives" style="marginLeft:550px;lineHeight:50px"><el-button type="primary" size="small" @click=" xiangqing">确定</el-button></li>
      ...
      init(){
         rechargecardedit({id:this.b}).then( res => {
            //  console.log(res.data.data)
             ...
             this.str.createTime = this.getTime(this.str.createTime)
         })
      },
      xiu(){
