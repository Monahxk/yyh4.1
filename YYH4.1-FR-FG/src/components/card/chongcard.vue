<template>
  <div class="wrapper">
    <el-dialog title="充值" :visible.sync="isShow.chong" width="800px" @open="init" :close-on-click-modal="false" @close="closeFn">
      <div>
        ...
        <div slot="footer" class="dialog-footer">
          <ul style="display:flex;marginTop:-50px">
            ...
            <li class="actives" style="marginLeft:450px;lineHeight:50px">
              <el-button type="primary" size="small" @click="ding">确定</el-button>
            </li>
...
export default {
  ...
  methods: {
    ...
    ding() {
      this.isShow.chong = !this.isShow.chong;
      let formData = new FormData();
      formData.append("cardId",this.c);
      ...
      formData.append("ownerId", this.str.patientId);
    ...
    enterInpFn() {
    //  console.log(this.huo[this.huoe].ActivityName);
    let i = ''
    ...
    init() {
      rechargecardedit({ id: this.c }).then(res => {
