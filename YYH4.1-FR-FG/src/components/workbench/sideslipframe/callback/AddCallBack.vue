<!--
 * @Descripttion: 患者详情，新增回访
 * @version: V4.1
 * @Author: hzj
 * @Date: 2019-09-09 16:23:32
 * @LastEditors: hzj
 * @LastEditTime: 2019-11-06 10:02:35
 -->
<template>
        ...
        <div class="dialog_content_center">
          <div class="content_center_row">
            ...
            <div class="content_center_row_left fl">
              ...
              <span class="val">{{stateData.gender}}</span>
            </div>
        ...
        <div class="dialog_tabs">
          ...
          <div class="add_box">
            ...
            <el-form ref="form" :model="form" label-width="90px" v-show="callbackMode == 1">
              <el-row>
                <el-col :span="11">
                  <el-form-item label="回访人员" prop="callerId" :required="true">
                ...
                <el-col :span="11">
                  <el-form-item label="回访时间" prop="callTime" :required="true">
                    <el-date-picker
              ...
              <el-row>
                <el-col :span="11">
                  <el-form-item label="诊治医生" prop="doctorId" :required="true">
                ...
                <el-col :span="11">
                  <el-form-item label="回访状态" prop="status" :required="true">
              ...
              <el-row>
                <el-col :span="11">
                  <el-form-item label="回访内容" prop="content" :required="true">
                    <el-select
            ...
            <el-form ref="userInfo" :model="userInfo" label-width="80px" v-show="callbackMode == 2">
              <el-row>
                <el-col :span="11">
                  <el-form-item label="回访人员" prop="callerId">
                ...
                <el-col :span="11">
                  <el-form-item label="回访计划" prop="periods">
...
<script>
import { getCallbackvo, postAddCallback } from "@/api";
import qs from "qs";
  ...
  methods: {
    ...
    sendDataFn() {
      if (this.callbackMode == 1) {
        ...
        this.form.patientIds = [this.patientId];
        ...
        this.userInfo.patientName = this.stateData.patientName;
        this.userInfo.patientId = this.patientId;
        this.userInfo.patientIds = [this.patientId];
        this.userInfo.visitTime = this.getTime(this.stateData.visitTime);
        console.log(JSON.stringify(this.userInfo))
        postAddCallback(this.userInfo).then(res => {
          if (res.data.code == SYSTEM_HTTP_SUCCESS) {
            this.isShow.register = false;
            this.$emit("successData");
          }
