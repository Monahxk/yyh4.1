<!--
@Descripttion: 营销管理，折扣卡
@Author: ZJZ
@Date:   2019-08-01
@Filename: Discount.vue
  ...
  <div class="wrapper">
    <div class="charge_item" ref="charge_item">
      <div class="box_header" ref="box_header">
        ...
        <div class="add_btn" @click="addChargDialog('add')">新办折扣卡</div>
      </div>
      ...
      <addDiscountCardDialog :dialogCfg="dialogCfg" @getTableList="getTableList"></addDiscountCardDialog>
...
import addDiscountCardDialog from './components/AddDiscountCardDialog'
import editCardDialog from './components/EditCardDialog'
import flowDetailDialog from './components/FlowDetailDialog'
import cardDetailDialog from './components/CardDetailDialog'

import {discountcardList,listClinicUser} from '@/api'
...
export default {
  ...
  methods: {
    ...
    addChargDialog(type,id){
      ...
      if(type == 'add'){
        _this.dialogCfg.add.title = '新增折扣卡'
      } else if(type == 'edit'){
        _this.dialogCfg.add.title = '修改折扣卡';
        _this.dialogCfg.add.id = id;
      } else if(type == 'recharge') {
        _this.dialogCfg.add.title = '折扣卡-充值';
        _this.dialogCfg.add.id = id;
      }
