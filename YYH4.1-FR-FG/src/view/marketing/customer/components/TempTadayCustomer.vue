...
@Author: ZJZ
@Date:   2019-08-01
@Filename: TempTadayCustomer.vue
          ...
          <el-form>
            <el-row>
              ...
              <el-col :span="2">
                <div class="right" >
                  <el-row>
                    <el-button type="primary" class="search_btn" round  @click="seach()">查询</el-button>
                  </el-row>
                </div>
              </el-col>
            </el-row>
          ...
          <el-form  >
            <el-row>
              ...
              <el-col :span="7">
                ...
                >
                  <el-select
                    v-model="customerObj.consultant"
                    placeholder="请选择"
              ...
              <el-col :span="7">
                ...
                >
                  <el-select style v-model="customerObj.consultItem" placeholder="请选择">
                    <el-option
                      v-for="(item,index) in consulprojectList"
                      :key="index"
                      :label="item.name"
                      :value="item.id"
                    ></el-option>
  ...
  methods: {
    ...
    initList() {
      getCustomerDownList({}).then(res => {
        ...
        this.consulprojectList = res.data.data.consultItemList;
