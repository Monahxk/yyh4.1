 ...
 * @LastEditors: hzj
 * @LastEditTime: 2019-11-01 14:46:20
 -->
<template>
...
import {getFinanceDiscountCardFlow} from '@/api'
export default {
  name: 'DiscountCardDetailDialog',
	components: {
	},
  props: ['dialog'],
	data() {
  ...
  mounted() {
	...
	methods: {
    openDialog() {
      getFinanceDiscountCardFlow(this.dialog.id).then(res => {
