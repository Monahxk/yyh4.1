 ...
 * @version: v4.1
 * @Author: hzj
 * @Date: 2019-08-28 10:04:07
 * @LastEditors: hzj
 * @LastEditTime: 2019-11-15 18:05:16
 -->
...
import {getRechargeFlow,getPredepositCardFlowTotal} from '@/api'
export default {
	name: 'predepositCard',
  ...
  data() {
      ...
      tableTitle: [
        {
          prop: 'predepositCard.cardNo',
          label: '卡号',
          width: '200'
        },
        {
          prop: 'predepositCard.patient.patientName',
          label: '患者姓名',
        },
        // {
        //   prop: 'predepositCard.patient.sourceName',
        //   label: '患者来源',
        // },
        {
          prop: "predepositCard.patient.gender",
          label: "性别",
        ...
        {
          prop: "predepositCard.patient.age",
          label: "年龄"
        },
        {
          prop: 'predepositCard.patient.emrNo',
          label: '病历号',
        },
        // {
        //   prop: 'predepositCard.type',
        //   label: '交易类型',
        //   ismoney: true
        // },
        {
	...
	methods: {
      ...
      let params = {page:this.pageConfig.currentPage,pageSize: this.pageConfig.pageSize};
			getRechargeFlow(Object.assign(params,this.formSearch)).then(res => {
      ...
      getPredepositCardFlowTotal(this.formSearch).then(res => {
        if(res.data.code == SYSTEM_HTTP_SUCCESS) {
    ...
    search() {
      ...
      if(this.formSearch.queryFlag == '0') {
