 ...
 * @LastEditors: hzj
 * @LastEditTime: 2019-11-15 18:04:48
 @mouseover.native="showQuery = true"
 -->
<template>
	<div class="wrapper">
...
import {getRechargecard,getPredepositCardTotal} from '@/api'
export default {
	name: 'predepositCard',
  ...
  data() {
      ...
      tableTitle: [
        ...
        // },
        // {
        //   prop: 'predepositCard.discountAmountYuan',
        //   label: '赠送金额',
        //   formatter: function(row, column, cellValue) {
        //     return '￥' + cellValue;
        //   }
        // },
        // {
        //   prop: 'predepositCard.receivedAmountYuan',
        //   label: '消费总额',
        //   formatter: function(row, column, cellValue) {
        //     return '￥' + cellValue;
        //   }
	...
	methods: {
      ...
      let params = {page:this.pageConfig.currentPage,pageSize: this.pageConfig.pageSize};
			getRechargecard(Object.assign(params,this.formSearch)).then(res => {
      ...
      getPredepositCardTotal(this.formSearch).then(res => {
        if(res.data.code == SYSTEM_HTTP_SUCCESS) {
