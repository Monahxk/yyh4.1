  ...
  <div class="storage_access wrapper">
    ...
    <div class="content main-content">
      ...
      <div class="title_text">
        <i></i> <span v-if='timeVal==1'>{{monthTime[0]}} ~ {{monthTime[1]}} 采购报表</span> <span v-if='timeVal==0'>{{dayTime[0]}} ~ {{dayTime[1]}} 采购报表</span>
      ...
      <div class="table_list">
        ...
        <el-table-column prop="drugTypeText" label="物品类别" align="center" sortable></el-table-column>
          ...
          <el-table-column prop="drugProviderText" label="供应商" align="center" sortable></el-table-column>
          <el-table-column prop="importInventoryRecordItem.quantity" label="采购数量" align="center" sortable></el-table-column>
...
<script>
import {importinventoryreportfilterdo,purchasereporttList,purchasereportExport} from "@/api/index2.js";
export default {
  name: 'stock',
  components: {
  ...
  methods: {
    setData(){
      purchasereporttList({params:this.searchForm}).then(res=>{
    ...
    exportFun(){
      ...
      purchasereportExport(this.searchForm).then(res=>{
