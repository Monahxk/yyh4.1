  ...
  <div class="storage_access wrapper">
    ...
    <div class="content">
      ...
      <div class="title_text">
        <i></i> <span v-if='timeVal==1'>{{monthTime[0]}} ~ {{monthTime[1]}} 盘点报表</span> <span v-if='timeVal==0'>{{dayTime[0]}} ~ {{dayTime[1]}} 盘点报表</span>
      ...
      <div class="table_list">
        ...
        >
          ...
          <el-table-column prop="exportInventoryRecordItem.drug.drugUnitsConfig.unitName" label="物品类别" align="center" sortable></el-table-column>
          <el-table-column prop="exportInventoryRecordItem.quantity" label="盘点数量" align="center" sortable></el-table-column>
...
<script>
import {importinventoryreportfilterdo,checkinventoryreportList,checkinventoryreportExport} from "@/api/index2.js";
export default {
  name: 'stock',
  components: {
  ...
  methods: {
    setData(){
      checkinventoryreportList({params:this.searchForm}).then(res=>{
    ...
    exportFun(){
      ...
      checkinventoryreportExport(this.searchForm).then(res=>{
