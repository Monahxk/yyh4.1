  ...
  <div class="storage_access wrapper">
    <div class="top">
      ...
      <div class="search_chunk">
        <el-select size="small" v-model="searchForm.wareHouseId" placeholder="选择库房" @change='searchFun'>
    ...
    <div class="content main-content">
      ...
      <div class="title_text">
        <i></i> <span v-if='timeVal==1'>{{monthTime[0]}} ~ {{monthTime[1]}} 入库报表</span> <span v-if='timeVal==0'>{{dayTime[0]}} ~ {{dayTime[1]}} 入库报表</span>
      ...
      <div class="table_list">
        ...
        >
          <el-table-column   type="expand" align="center" >
            <template slot-scope="scope" >
              ...
              >
                ...
                <el-table-column prop="quantity" label="入库库存" align="center" sortable></el-table-column>
              </el-table>
          ...
          <el-table-column align="center" prop="drugTypeText" label="物品类别" sortable></el-table-column></el-table-column>
          <el-table-column prop="importInventoryRecordItem.drug.drugCode" label="物品编号" align="center" sortable></el-table-column>
          <el-table-column prop="importInventoryRecordItem.drug.drugName" label="物品名称" align="center" sortable></el-table-column>
          <el-table-column prop="importInventoryRecordItem.drug.drugSpec" label="规格" align="center" sortable></el-table-column>
          <el-table-column prop="importInventoryRecordItem.drug.drugBrand.brandName" label="品牌" align="center" sortable></el-table-column>
          <el-table-column prop="importInventoryRecordItem.drug.drugUnitsConfig.unitName" label="单位" align="center" sortable></el-table-column>
          <el-table-column prop="importInventoryRecordItem.quantity" label="入库数量" align="center" sortable></el-table-column>
          <el-table-column prop="averagePriceYuan" label="均价" align="center" sortable></el-table-column>
          <el-table-column prop="importInventoryRecordItem.amountYuan" label="金额" align="center" sortable></el-table-column>
...
import {importinventoryreportfilterdo,importinventoryreportList,importinventoryreportExport} from "@/api/index2.js";
export default {
  name: 'stock',
  components: {
  ...
  methods: {
    setData(){
      importinventoryreportList({params:this.searchForm}).then(res=>{
    ...
    exportFun(){
      ...
      importinventoryreportExport(this.searchForm).then(res=>{
