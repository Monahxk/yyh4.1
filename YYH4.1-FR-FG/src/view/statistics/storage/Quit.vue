  ...
  <div class="storage_access wrapper">
    ...
    <div class="content main-content">
      ...
      <div class="title_text">
        <i></i> <span v-if='timeVal==1'>{{monthTime[0]}} ~ {{monthTime[1]}} 退库报表</span> <span v-if='timeVal==0'>{{dayTime[0]}} ~ {{dayTime[1]}} 退库报表</span>
        ...
        >
          <el-table-column   type="expand" align="center" >
            <template slot-scope="scope" >
              <el-table
                highlight-current-row
                :data="scope.row.returnInventoryBatchList"
              ...
              >
                ...
                <el-table-column prop="quantity" label="退库数量"  align="center" sortable></el-table-column>
              </el-table>
          ...
          <el-table-column prop="drugReturnInventoryItem.drug.drugCode" label="物品编号" align="center" sortable></el-table-column>
          <el-table-column prop="drugReturnInventoryItem.drug.drugName" label="物品名称" align="center" sortable></el-table-column>
          <el-table-column prop="drugReturnInventoryItem.drug.drugSpec" label="规格" align="center" sortable></el-table-column>
          <el-table-column prop="drugReturnInventoryItem.drug.drugUnitsConfig.unitName" label="单位" align="center" sortable></el-table-column>

          <el-table-column prop="drugReturnInventoryItem.quantity" label="退库数量" align="center" sortable></el-table-column>
...
<script>
import {importinventoryreportfilterdo,returninventoryreportList,returninventoryreportExport} from "@/api/index2.js";
export default {
  name: 'stock',
  components: {
  ...
  methods: {
    setData(){
      returninventoryreportList({params:this.searchForm}).then(res=>{
    ...
    exportFun(){
      ...
      returninventoryreportExport(this.searchForm).then(res=>{
