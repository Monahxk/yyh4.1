  ...
  <div class="storage_access wrapper">
    ...
    <div class="content main-content">
      ...
      <div class="title_text">
        <i></i> <span v-if='timeVal==1'>{{monthTime[0]}} ~ {{monthTime[1]}} 出库报表</span> <span v-if='timeVal==0'>{{dayTime[0]}} ~ {{dayTime[1]}} 出库报表</span>
        ...
        >
          <el-table-column   type="expand" align="center" >
            <template slot-scope="scope" >
              <el-table
                highlight-current-row
                :data="scope.row.exportInventoryBatchList"
              ...
              >
                ...
                <el-table-column prop="amountYuan" label="单价"  align="center" sortable></el-table-column>
          ...
          <el-table-column prop="exportInventoryRecordItem.drug.drugBrand.brandName" label="品牌" align="center" sortable></el-table-column>
          ...
          <el-table-column prop="exportInventoryRecordItem.quantity" label="出库数量" align="center" sortable></el-table-column>
          <el-table-column prop="averagePriceYuan" label="均价" align="center" sortable></el-table-column>
          <el-table-column prop="exportInventoryRecordItem.amountYuan" label="金额" align="center" sortable></el-table-column>
...
<script>
import {importinventoryreportfilterdo,exportinventoryreportList,exportinventoryreportExport} from "@/api/index2.js";
export default {
  name: 'stock',
  components: {
  ...
  methods: {
    setData(){
      this.tableData=[]
      exportinventoryreportList({params:this.searchForm}).then(res=>{
    ...
    exportFun(){
      ...
      exportinventoryreportExport(this.searchForm).then(res=>{
