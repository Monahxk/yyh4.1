 ...
 * @version: v4.1
 * @Author: hzj
 * @Date: 2019-08-26 11:49:05
 * @LastEditors: hzj
 * @LastEditTime: 2019-11-11 18:06:29
 -->
<template>
	<div class="wrapper">
		<header class="header-page" :class="{'show-query': showQuery}">
          ...
          <div class="nav_item">
            ...
            v-model="formSearch.nameOrNumber"
        ...
        >
          ...
          <el-table-column prop="scheduleDay" label="临期天数" sortable  align="center"></el-table-column>
        </el-table>
			</section>
			<footer class="footer">
...
import {listExpireWarning,getinventorywarningDO} from '@/api'
export default {
	name: 'ExpireWarning',
  ...
  data() {
	...
	methods: {
		getTableList() {
			...
			listExpireWarning(Object.assign(params,this.formSearch)).then(res => {
